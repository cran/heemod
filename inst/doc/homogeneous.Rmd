...
Both models can then be run for 20 years with `run_model`. Models are given simple names (`mono` and `comb`) in order to facilitate result interpretation. To replicate results from the original study we assume transitions occur at the end of each cycles (`method = "end"`).
