...
The new treatment costs £1063 less per QALY gained, and thus dominates the standard treatment.

It should be noted that this was not the case in the original study. This difference is explained by higher population-level all-causes mortality rates in the original study than in the WHO database (used here). You can try to increase mortality probablity to rates closer to the original study to get closer results:

```
mr = get_who_mr(age, sex_cat, country = "GBR") * 2
```
